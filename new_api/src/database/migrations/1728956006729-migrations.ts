...
export class Migrations1728956006729 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "consumiveis" ADD CONSTRAINT "FK_72e0681538ef0c35672f58c8ddd" FOREIGN KEY ("gasto_id") REFERENCES "gastos"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "vacinas" ADD CONSTRAINT "FK_b4836747dd8f141da571ce08d19" FOREIGN KEY ("gasto_id") REFERENCES "gastos"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "medicamentos" ADD CONSTRAINT "FK_13dd2697687215fd62c7e6e48cf" FOREIGN KEY ("gasto_id") REFERENCES "gastos"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "veterinarios" ADD CONSTRAINT "FK_6e1e62399c7dbd971c6cc21a501" FOREIGN KEY ("pessoa_id") REFERENCES "pessoas"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "castracoes" ADD CONSTRAINT "FK_389a2bba95d30e5017c34840e46" FOREIGN KEY ("gasto_id") REFERENCES "gastos"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "doacoes" ADD CONSTRAINT "FK_0303f292ffcbcba9dd5ecd20f8c" FOREIGN KEY ("doadorId") REFERENCES "doadores"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "doacoes" ADD CONSTRAINT "FK_7bd60594c9477a2ddf1560123f0" FOREIGN KEY ("gasto_id") REFERENCES "gastos"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "doadores" ADD CONSTRAINT "FK_67d29074c0f1b7e627edba31097" FOREIGN KEY ("pessoa_id") REFERENCES "pessoas"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "adotante" ADD CONSTRAINT "FK_c1967c46a381234c432b280e2de" FOREIGN KEY ("pessoa_id") REFERENCES "pessoas"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "adotante" ADD CONSTRAINT "FK_c1967c46a381234c432b280e2de" FOREIGN KEY ("pessoa_id") REFERENCES "pessoas"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
